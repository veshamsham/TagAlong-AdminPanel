      ...
      activity_list.map((data, index) =>
        results.push({
         ...
         // address: data.address,
          ...
          action_by: data.actionBy.userName+' - '+moment(data.actionBy.actionDate).format('DD/MM/YYYY'),
          inspection_by: data.inspectionBy.userName+' - '+moment(data.actionBy.inspectionDate).format('DD/MM/YYYY'),
          documents: (
            // <Link
            //   to={{
